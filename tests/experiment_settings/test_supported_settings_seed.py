...
class Test_seed_settings(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.valid_seed = self.supp_experi_config.seed
    ...
    def test_error_is_thrown_for_invalid_seed_value_type(self):
        ...
        # Create deepcopy of configuration settings.
        experi_config = copy.deepcopy(self.with_adaptation_with_radiation)
        expected_type = type(self.supp_experi_config.seed)

        # Verify it throws an error on None and string.
        for invalid_config_setting_value in [None, ""]:
            experi_config["seed"] = invalid_config_setting_value
            verify_error_is_thrown_on_invalid_configuration_setting_value(
